...
```{r}
Reduce(intersect, list(northern_boundary_species, southern_boundary_species))
```

Opalia wroblewskyi is in both
```{r}
...
```{r}
range_plot("Norrisia norrisii")
range_trend("Norrisia norrisii")
```
...
[1] "Acmaea mitra"                            
[2] "Amphissa columbiana"                     
[3] "Calliostoma annulatum"                   
[4] "Calliostoma ligatum"                     
[5] "Cirolana spp/Gnorimosphaeroma oregonense"
[6] "Coryphella trilineata"                   
[7] "Cryptochiton stelleri"                   
[8] "Onchidella carpenteri"                   
[9] "Tegula brunnea"   
