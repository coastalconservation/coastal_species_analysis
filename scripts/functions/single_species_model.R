...
single_species_model <- function(species){
  ...
  # ESDM represents data from the current period
  # TEST TOOK OUT ,'GBM','MAXENT'
  ESDM <- ensemble_modelling(c('GBM','GAM','GLM','MARS','CTA','ANN','RF','SVM'), 
                             species_subset, 
                             env_00_load, 
                             Xcol = 'longitude', 
                             Ycol = 'latitude', 
