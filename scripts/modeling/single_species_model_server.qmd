...
This is to test running models with both absence and presence data. To get models to run with presence and abense data (not just presence data) I subsetted the data to the species of interest outside of the model function and ensured it was a data frame before running the model. I also added a *pcol* argument to the model. This arguement tells the model where the presence/absence data should be found. 
