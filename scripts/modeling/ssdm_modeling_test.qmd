...
# MAYBE I SHOULD FILTER THE YEARS TO HAVE LESS DATA 
# 2018-2024? 

# FILTER YEARS HERE 

# Filter years to be from 2018-2024
...
biodiv_total <- biodiv_2025 %>% 
  group_by(marine_site_name, latitude, longitude, species_lump) %>% # Is the marine site name the issue? 
...
```{r}
ext(env_00)
# max lat = 43.0500015284681
# min lat = 31.9500003788806
# max long = -125.999998474121
# min long = -115.949998474121

max(spp_j_verrucosa$latitude)
min(spp_j_verrucosa$latitude)
max(spp_j_verrucosa$longitude)
min(spp_j_verrucosa$longitude)

# Might need to remove observations outside of extent, but I will check if the model works without doing this  
```
